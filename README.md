...
Сервис написан полностью на чистом GO(используется только стандартная либа)
...
- Реализовал пакет envload, помогает загрузить перменные окружения из env файла.
